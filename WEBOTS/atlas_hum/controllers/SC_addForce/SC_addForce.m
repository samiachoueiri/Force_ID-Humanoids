...
%get node ID
%id_RLleg = wb_supervisor_node_get_from_def('RLleg_S')
%id_RUleg = wb_supervisor_node_get_from_def('RUleg_S')
%id_LLleg = wb_supervisor_node_get_from_def('LLleg_S')
%id_LUleg = wb_supervisor_node_get_from_def('LUleg_S')
%id_Pelvis = wb_supervisor_node_get_from_def('Pelvis_S')
%id_Utorso = wb_supervisor_node_get_from_def('Utorso_S')
%id_RLarm = wb_supervisor_node_get_from_def('RLarm_S')
%id_LLarm = wb_supervisor_node_get_from_def('LLarm_S')
%id_RScap = wb_supervisor_node_get_from_def('RScap_S')
%id_LScap = wb_supervisor_node_get_from_def('LScap_S')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%id = wb_supervisor_node_get_from_def('RLleg_S')
%id = wb_supervisor_node_get_from_def('RUleg_S')
%id = wb_supervisor_node_get_from_def('LLleg_S')
%id = wb_supervisor_node_get_from_def('LUleg_S')
%id = wb_supervisor_node_get_from_def('Pelvis_S')
%id = wb_supervisor_node_get_from_def('Utorso_S')
%id = wb_supervisor_node_get_from_def('RLarm_S')
%id = wb_supervisor_node_get_from_def('LLarm_S')
...
%for k=1:70
if k<=20
  %%wb_supervisor_node_add_force(id_Pelvis,[FX 0 0],1);
  wb_supervisor_node_add_force(id,[FX 0 0],1);
end
...
LArmEly(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_LArmEly);
LArmMwx(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_LArmMwx);
LArmShx(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_LArmShx);
LArmUsy(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_LArmUsy);
...
LLegLax(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_LLegLax);
...
LLegUhz(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_LLegUhz);
...
RArmEly(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_RArmEly);
RArmMwx(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_RArmMwx);
RArmShx(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_RArmShx);
RArmUsy(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_RArmUsy);
...
RLegLax(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_RLegLax);
...
RLegUhz(SAMPLE,k)=wb_position_sensor_get_value(pos_sensor_RLegUhz);

  wb_console_print(sprintf('k %f\n', k), WB_STDOUT);
  wb_console_print(sprintf('SAMPLE %f\n', SAMPLE), WB_STDOUT);
%end
if k==70
save('1K2S.mat','BackLbz','BackMby','BackUbx','LArmElx','LArmEly','LArmMwx','LArmShx','LArmUsy','LArmUwy','LLegKny','LLegLax','LLegLhy','LLegMhx','LLegUay','LLegUhz','NeckAy','RArmElx','RArmEly','RArmMwx','RArmShx','RArmUsy','RArmUwy','RLegKny','RLegLax','RLegLhy','RLegMhx','RLegUay','RLegUhz')
%quit(0);
%k=1;
%SAMPLE = SAMPLE+1;
%FX=FX+100;
