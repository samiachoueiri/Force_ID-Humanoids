...
if wait>=BUF
if k<=FD
  wb_supervisor_node_add_force(id_RLleg,[FX 0 0],1);
end
...
if k==S
save('RLL2KX2S_B10S.mat','BackLbz','BackMby','BackUbx','LArmElx','LArmEly','LArmMwx','LArmShx','LArmUsy','LArmUwy','LLegKny','LLegLax','LLegLhy','LLegMhx','LLegUay','LLegUhz','NeckAy','RArmElx','RArmEly','RArmMwx','RArmShx','RArmUsy','RArmUwy','RLegKny','RLegLax','RLegLhy','RLegMhx','RLegUay','RLegUhz')
