...
if FX>800
wb_supervisor_simulation_quit(-1)
end
if wait>=BUF
if k<=FD
...
F(SAMPLE,1)=FX;
L(SAMPLE,1)=LOC;
save('try_PELVIS_B10.mat','BackLbz','BackMby','BackUbx','LArmElx','LArmEly','LArmMwx','LArmShx','LArmUsy','LArmUwy','LLegKny','LLegLax','LLegLhy','LLegMhx','LLegUay','LLegUhz','NeckAy','RArmElx','RArmEly','RArmMwx','RArmShx','RArmUsy','RArmUwy','RLegKny','RLegLax','RLegLhy','RLegMhx','RLegUay','RLegUhz')
%save('F_PELVIS.mat','F')
%save('L_PELVIS.mat','L')
k=1;
SAMPLE = SAMPLE+1;
