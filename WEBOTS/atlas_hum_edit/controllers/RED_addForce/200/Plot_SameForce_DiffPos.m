...
LLL=load('200X2S_LLL.mat');
RLL=load('200X2S_RLL.mat');
LSCAP=load('200X2S_LSCAP.mat');
RSCAP=load('200X2S_RSCAP.mat');
PELVIS=load('200X2S_PELVIS.mat');
TORSO=load('200X2S_TORSO.mat');
...
LArmUwy = [LLL.LArmUwy; RLL.LArmUwy; LSCAP.LArmUwy; RSCAP.LArmUwy; PELVIS.LArmUwy; TORSO.LArmUwy];
...
RArmUwy = [LLL.RArmUwy; RLL.RArmUwy; LSCAP.RArmUwy; RSCAP.RArmUwy; PELVIS.RArmUwy; TORSO.RArmUwy];
