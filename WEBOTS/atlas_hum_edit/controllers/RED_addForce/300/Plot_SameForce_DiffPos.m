...
LLL=load('300X2S_LLL.mat');
RLL=load('300X2S_RLL.mat');
LSCAP=load('300X2S_LSCAP.mat');
RSCAP=load('300X2S_RSCAP.mat');
PELVIS=load('300X2S_PELVIS.mat');
TORSO=load('300X2S_TORSO.mat');
