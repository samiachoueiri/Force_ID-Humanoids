...
LLL=load('100X2S_LLL.mat');
RLL=load('100X2S_RLL.mat');
LSCAP=load('100X2S_LSCAP.mat');
RSCAP=load('100X2S_RSCAP.mat');
PELVIS=load('100X2S_PELVIS.mat');
TORSO=load('100X2S_TORSO.mat');
