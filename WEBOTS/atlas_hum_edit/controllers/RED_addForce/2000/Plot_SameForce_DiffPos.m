...
LLL=load('2000X2S_LLL.mat');
RLL=load('2000X2S_RLL.mat');
%LSCAP=load('750X2S_LSCAP.mat');
%RSCAP=load('750X2S_RSCAP.mat');
%PELVIS=load('750X2S_PELVIS.mat');
%TORSO=load('750X2S_TORSO.mat');
BackLbz = [LLL.BackLbz; RLL.BackLbz];
BackMby = [LLL.BackMby; RLL.BackMby];
BackUbx = [LLL.BackUbx; RLL.BackUbx];
NeckAy = [LLL.NeckAy; RLL.NeckAy];
LArmElx = [LLL.LArmElx; RLL.LArmElx];
LArmMwx = [LLL.LArmMwx; RLL.LArmMwx];
LArmUwy = [LLL.LArmUwy; RLL.LArmUwy];
RArmElx = [LLL.RArmElx; RLL.RArmElx];
RArmMwx = [LLL.RArmMwx; RLL.RArmMwx];
RArmUwy = [LLL.RArmUwy; RLL.RArmUwy];
LLegKny = [LLL.LLegKny; RLL.LLegKny];
LLegLhy = [LLL.LLegLhy; RLL.LLegLhy];
LLegMhx = [LLL.LLegMhx; RLL.LLegMhx];
LLegUay = [LLL.LLegUay; RLL.LLegUay];
RLegKny = [LLL.RLegKny; RLL.RLegKny];
RLegLhy = [LLL.RLegLhy; RLL.RLegLhy];
RLegMhx = [LLL.RLegMhx; RLL.RLegMhx];
RLegUay = [LLL.RLegUay; RLL.RLegUay];
