...
LLL=load('400X2S_LLL.mat');
RLL=load('400X2S_RLL.mat');
LSCAP=load('400X2S_LSCAP.mat');
RSCAP=load('400X2S_RSCAP.mat');
PELVIS=load('400X2S_PELVIS.mat');
TORSO=load('400X2S_TORSO.mat');
